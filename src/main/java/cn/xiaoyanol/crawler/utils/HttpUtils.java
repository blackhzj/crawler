...
public class HttpUtils {
    ...
    private static void setHttpHeaders(HttpGet httpGet) {
        ...
        httpGet.setHeader("authorization", "0###oo34J0Vj5y3jrTeawGagYdqr3hsA###1555509053449###c93b4fa3be1712e7c597caa2557eba1c");
        httpGet.setHeader("referer", "https://servicewechat.com/wx9f2867fc22873452/21/page-frame.html");
...
//        httpGet.setHeader("x-auth-token", "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxNTY2NzAyMDUwMSIsImlhdCI6MTU0MTY0NzEyMiwiZXhwIjoxNTQ0MjM5MTIyfQ.sW2MMsSoZxQlgaD5-Fu_XUXKv7H1_N0TSFHAG93Y2db0HzVKjZINt5sUU1w8nExXT6FATiTU1jDHNQFMhN0VFw");
        httpGet.setHeader("User-Agent", "Mozilla/5.0 (Linux; Android 9; MIX 3 Build/PKQ1.180729.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/73.0.3683.90 Mobile Safari/537.36 MicroMessenger/7.0.3.1400(0x2700033D)");
